...
describe('MobileNavigation', () => {
  ...
  describe('Initialization', () => {
    test('should initialize with correct elements', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('✅ Mobile navigation initialized');
    ...
    test('should warn if elements are missing', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Mobile navigation elements not found');
  ...
  describe('Menu Toggle', () => {
    ...
    test('should add/remove active classes on toggle', () => {
      ...
      mobileNavigation.toggle();
      expect(mobileNavigation.burgerMenu.classList.contains('active')).toBe(true);
      expect(mobileNavigation.mobileMenu.classList.contains('active')).toBe(true);

      mobileNavigation.toggle();
      expect(mobileNavigation.burgerMenu.classList.contains('active')).toBe(false);
      expect(mobileNavigation.mobileMenu.classList.contains('active')).toBe(false);
    });
  ...
  describe('Menu Opening', () => {
    ...
    test('should set aria-expanded attribute', () => {
      ...
      expect(mobileNavigation.burgerMenu.getAttribute('aria-expanded')).toBe('true');
    });
  });
  ...
  describe('Menu Closing', () => {
    ...
    test('should set aria-expanded attribute to false', () => {
      ...
      expect(mobileNavigation.burgerMenu.getAttribute('aria-expanded')).toBe('false');
    });
  });
