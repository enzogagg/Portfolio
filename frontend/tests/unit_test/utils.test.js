...
import { forceElementVisibility, forceProjectCardVisibility } from '../../assets/js/modules/utils.js';
...
describe('Utils Module', () => {
  ...
  describe('Integration Tests', () => {
    ...
    test('should preserve existing classes except project-hidden', () => {
      const element = document.createElement('div');
      element.classList.add('project-card', 'featured', 'project-hidden', 'active');
      document.body.appendChild(element);
